<?php
  ...
  class DB
  {
    ...
    function __construct($base, $server, $user, $pass)
    {
      ...
      $this->connection = mysqli_connect($server, $user, $pass) or die('Server connexion not possible.');
      mysqli_select_db($this->connection,$base)               or die('Database connexion not possible.');
